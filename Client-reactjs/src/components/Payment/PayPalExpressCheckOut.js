...
class PaypalButton extends React.Component {
    render() {		
		...
		const client = {
			...
			production: 'AZs_W1F_gJm6l6Vy8jkoLg_PunU0RVl8y0BVK_xrKkQZ05jDO3BeMJmlpq-HCu0QyUSCNmKzBEQQHFsT',
		}
        ...
        return (
            <PaypalExpressBtn env={env} client={client} payment={payment} onAuthorize={onAuthorize} currency={currency} total={total} onError={onError} onSuccess={onSuccess} onCancel={onCancel} />
        );
    }
}
